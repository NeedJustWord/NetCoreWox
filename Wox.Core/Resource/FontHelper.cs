...
namespace Wox.Core.Resource
{
    ...
    {
        static readonly FontWeightConverter fontWeightConverter = new FontWeightConverter();
        ...
        static readonly FontStyleConverter fontStyleConverter = new FontStyleConverter();
        ...
        static readonly FontStretchConverter fontStretchConverter = new FontStretchConverter();
